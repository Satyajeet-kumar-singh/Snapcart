"use client"
import { Apple, Baby, Box, ChevronLeft, ChevronRight, Coffee, Cookie, Flame, Heart, Home, Milk, ShoppingCart, Wheat } from 'lucide-react';
...
function CategorySlider() {
  ...
  return (
    ...
    viewport={{once:false,amount:0.5}}>
      <h2 className='text-2xl md:text-3xl font-bold text-green-700 mb-6 text-center flex items-center justify-center gap-5'>
        <ShoppingCart className='w-8 h-8'/>Shop By Category</h2>
