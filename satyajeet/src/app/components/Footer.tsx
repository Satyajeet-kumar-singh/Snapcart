  ...
  return (
    ...
    className='bg-linear-to-r from-green-600 to-green-700 text-white mt-20'>
      ...
      <div>
        ...
        <ul className='sapce-y-2 text-green-100 text-sm'>
            <li className='flex items-center gap-2'>
                <MapPin size={16}/> Mumbai, India
            </li>
            <li className='flex items-center gap-2'>
                <Phone size={16}/> +91 8802284529
            </li>
            <li className='flex items-center gap-2'>
      ...
      <div className='text-center py-4 text-sm text-green-100 bg-green-800/40'>
        @ {new Date().getUTCFullYear()} <span className='font-semibold'>Snapcart</span>. All rights reserved.
      </div>
    </motion.div>
  )
}
