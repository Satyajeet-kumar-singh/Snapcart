...
function HeroSection() {
    const slides = [
        {
            ...
            btnText: "Shop Now",
            bg: "https://images.unsplash.com/photo-1518843875459-f738682238a6?q=80&w=842&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        },
        {
            id: 2,
            ...
            btnText: "Order Now",
            bg: "https://images.unsplash.com/photo-1695654390723-479197a8c4a3?q=80&w=834&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        },
        {
            id: 3,
            ...
            btnText: "Get Started",
            bg: "https://images.unsplash.com/photo-1488459716781-31db52582fe9?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        }
    ]
  ...
  return (
    <div className='relative w-[98%] mx-auto mt-32 h-[80vh] rounded-xl overflow-hidden shadow-2xl'>
      <AnimatePresence mode='wait'>
        ...
        className='absolute inset-0'>
            <Image src={slides[current]?.bg} alt='hero section' fill priority className='object-cover'/>
