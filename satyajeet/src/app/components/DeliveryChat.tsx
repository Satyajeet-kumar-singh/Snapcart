...
function DeliveryChat({orderId,deliveryBoyId}:{orderId:mongoose.Types.ObjectId,deliveryBoyId:mongoose.Types.ObjectId}) {
  ...
  const getSuggestions=async()=>{
    try {
      ...
      const result = await axios.post(`/api/chat/ai-suggestions`,{message:lastMessage,role:"delivery_boy"})
